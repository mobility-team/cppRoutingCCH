...
#' For a customized CCH metric, the CCH query is selected automatically and
#' \code{algorithm} is ignored. Use \link{get_path_values_pair} when other edge
#' values must be accumulated along the same CCH shortest paths.
#'
