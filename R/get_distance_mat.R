...
#'
#' @param Graph An object generated by \link{makegraph}, \link{cpp_simplify},
#' \link{cpp_contract}, or \link{cpp_cch_customize}.
...
#' }
#' For a customized CCH metric, the function uses pinned elimination-tree
#' queries and \code{algorithm} is ignored. The implementation chooses the
#' smaller endpoint side as the repeated query side and does not materialize a
#' destination-by-node distance table.
#'
