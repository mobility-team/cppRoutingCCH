...
cpppathvaluesC <- function(orfrom, orto, orw, values, gfrom, gto, gw, nb, rank, shortf, shortt, shortc, phast, dep, arr) {
    .Call(`_cppRoutingCCH_cpppathvaluesC`, orfrom, orto, orw, values, gfrom, gto, gw, nb, rank, shortf, shortt, shortc, phast, dep, arr)
}
...
cppdistmatcch <- function(NbNodes, rank, first_out, adj_head, adj_arc, elimination_tree_parent, forward, backward, dep, arr) {
    .Call(`_cppRoutingCCH_cppdistmatcch`, NbNodes, rank, first_out, adj_head, adj_arc, elimination_tree_parent, forward, backward, dep, arr)
}
