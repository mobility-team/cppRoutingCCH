...
#' @param cch Optional CCH topology generated by \link{cpp_cch_prepare}. Use it with CCH \code{aon_method} values to prepare the road topology once and reuse it across many congestion runs.
...
#' \code{cch <- cpp_cch_prepare(graph)} once, save it if needed, and pass
...
#' @references J. Dibbelt, B. Strasser, D. Wagner (2016). "Customizable
#' Contraction Hierarchies". ACM Journal of Experimental Algorithmics, 21,
#' Article 1.5. \doi{10.1145/2886843}.


assign_traffic <- function(Graph, from, to, demand, algorithm = "bfw", max_gap = 0.001, max_it = .Machine$integer.max,
                           aon_method = "bi", constant = 1, dial_params = NULL, verbose = TRUE, cch = NULL){
